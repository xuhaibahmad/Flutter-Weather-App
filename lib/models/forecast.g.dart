...
Rain _$RainFromJson(Map<String, dynamic> json) {
  return Rain(the3H: (json['the3H'] as num)?.toDouble());
}

Map<String, dynamic> _$RainToJson(Rain instance) =>
    <String, dynamic>{'the3H': instance.the3H};

Sys _$SysFromJson(Map<String, dynamic> json) {
  return Sys(pod: _$enumDecodeNullable(_$PodEnumMap, json['pod']));
}

Map<String, dynamic> _$SysToJson(Sys instance) =>
    <String, dynamic>{'pod': _$PodEnumMap[instance.pod]};
...
const _$PodEnumMap = <Pod, dynamic>{Pod.d: 'd', Pod.n: 'n'};
